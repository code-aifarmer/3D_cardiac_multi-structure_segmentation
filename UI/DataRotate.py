...
# Form implementation generated from reading ui file 'DataRotate.ui'
#
...
"}")
        ...
        self.Rotate_textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.Rotate_textEdit.setObjectName("Rotate_textEdit")
        self.verticalLayout.addWidget(self.Rotate_textEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "数据增强（旋转）"))
        self.pushButton.setText(_translate("MainWindow", "选择图像路径"))
        self.pushButton_2.setText(_translate("MainWindow", "选择标签路径"))
        self.pushButton_4.setText(_translate("MainWindow", "设置旋转角度"))
